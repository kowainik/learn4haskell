...
🤔 Blitz question: can you guess what this number (acc) represents?

The amount of time a number can be divided by 2, plus one. In other words,
2^[acc] is the first number greater than n, in base 2.
...
rewind :: [Int] -> [Int]
rewind [] = []
rewind l = last l : rewind (take (length l - 1) l)
