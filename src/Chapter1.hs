...
mid :: Int -> Int -> Int -> Int
mid x y z = do
    let maxN = foldr1 max [x, y, z]
    let minN = foldr1 min [x, y, z]
    [n | n <- [x,y,z], n < maxN, n > minN]!!0
...
-}
isVowel :: Char -> Bool
isVowel c = elem (toLower c) ['a', 'e', 'i', 'o', 'u', 'y']
...
-- getLast2 y =
--     let lastN = y `mod` 10
--         secondLastN = y `mod` 100
--     in(lastN, secondLastN)
