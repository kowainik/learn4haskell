...
sumLast2 :: Int -> Int
sumLast2 n =
    let helpNum = mod n 100
    in div helpNum 10 + lastDigit helpNum 

sumLast2where :: Int -> Int
sumLast2where n = div (last2 n) 10 + lastDigit (last2 n)
    where 
      last2 :: Int -> Int 
      last2 helpNum = mod helpNum 100
