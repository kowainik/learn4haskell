...
-}
sumLast2 :: Int -> Int
sumLast2 n = let secondDigit = div (mod (abs n) 100) 10 in secondDigit + lastDigit n
...
-}
firstDigit :: Int -> Int
firstDigit n = firstDigHelp (abs n) 10
    where
        firstDigHelp :: Int -> Int -> Int
        firstDigHelp origNum step
            | origNum /= mod origNum step = firstDigHelp origNum (10 * step)
            | otherwise =  div origNum (div step 10)
