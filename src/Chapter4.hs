...
concatenate x Empty = x
concatenate Empty x = x
concatenate (Cons x list) l = Cons x (concatenate list l)
...
instance Applicative List where
    ...
    Empty <*> _ = Empty
    Cons f list <*> l = concatenate (fmap f l) (list <*> l)
...
flatten Empty = Empty
flatten (Cons x list) = concatenate x (flatten list)
