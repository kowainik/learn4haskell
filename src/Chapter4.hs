...
instance Functor (List a) where
    ...
    fmap _ Empty = Empty
    fmap f (Cons a as) = Cons (f x) (fmap f xs)
...
concatList (Cons a as) x = Cons a (concatList as x)
...
fList :: List (List a) -> List a
fList Empty = Empty
fList (Cons a b) = concatList a (fList b)
